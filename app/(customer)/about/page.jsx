...
export default function AboutPage() {
  ...
  const coreValues = [
    {
      ...
      desc: "Our platform ensures the highest accuracy in test parameter mappings, reference range calculations, and result documentation.",
      icon: <HospitalIcon sx={{ fontSize: 40 }} color="primary" />
    },
    {
  ...
  return (
    <Box>
      ...
      {/* Values Section */}
      <Box sx={{ bgcolor: "rgba(15, 118, 110, 0.02)", py: { xs: 8, md: 12 }, borderTop: "1px solid rgba(0,0,0,0.03)", borderBottom: "1px solid rgba(0,0,0,0.03)" }}>
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 8, md: 12 } }}>
        <Box sx={{ textAlign: "center", mb: 8 }}>
          ...
          <Typography variant="h3" sx={{ fontWeight: 800, color: "text.primary" }}>
            Meet the innovators behind the tech
          </Typography>
        </Box>

        <Grid container spacing={4} justifyContent="center">
          {[
            { name: "Dr. Alok Verma", role: "Co-Founder & Clinical Director", initial: "AV" },
            { name: "Siddharth Sen", role: "Co-Founder & Technical Lead", initial: "SS" },
            { name: "Ananya Roy", role: "Head of Support & Training", initial: "AR" }
          ].map((member, idx) => (
            <Grid size={{ xs: 12, sm: 6, md: 4 }} key={idx}>
              <Card sx={{ textAlign: "center", border: "1px solid rgba(0,0,0,0.03)" }}>
                <CardContent sx={{ p: 5, display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                  <Avatar
                    sx={{
                      width: 72,
                      height: 72,
